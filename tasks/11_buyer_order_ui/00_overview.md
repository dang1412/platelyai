...
- [ ] [01_design_tokens.md](01_design_tokens.md) — thêm semantic token vào `globals.css` (light+dark)
- [ ] [02_types_meta_mock.md](02_types_meta_mock.md) — `lib/orders/{types,statusMeta(+test),mock}.ts`
