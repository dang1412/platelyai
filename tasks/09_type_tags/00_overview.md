...
- [ ] [02_extract_type_tag.md](02_extract_type_tag.md) — bỏ `category`, prompt gắn type-tag
...
- [ ] [07_drop_columns.md](07_drop_columns.md) — DROP cột (phase 2, sau khi 1–6 verified)
